...
export default function Analytics() {
  ...
  const fetchData = useCallback(async () => {
    setLoading(true);
    try {
      const [dashRes, perfRes, healthRes, peakRes] = await Promise.allSettled([
  ...
  return (
    <div className="analytics-dashboard">
      ...
      <div className="kpi-row">
        ...
        <KPICard icon="&#x1F465;" label="Active Users" value={summary.uniqueUsersToday || 0} trend={12} sparklineData={[12, 18, 22, 15, 28, 32, 25]} />
      ...
      <div className="analytics-grid">
        ...
        <div className="analytics-card card-static card">
          ...
          <BarChart data={sourceData} colors={['#3b82f6', '#22c55e', '#f97316', '#a78bfa']} />
        </div>
